...
1. Download `cursor-integration.zip` from the [latest release](https://github.com/px39n/obs_cursor/releases/latest)
...
```bash
cursor --install-extension px39n.obsidian-for-cursor
```
